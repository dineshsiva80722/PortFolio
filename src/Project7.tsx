...
// import project9 from './assets/image/project9.png'
// const Project3 = () => {
//     const content = {
//         title: "project",
//         projecttitle:"SoftSolve - Software Solutions Website",
//         projectcont:"SoftSolve is a professional and modern website designed for businesses offering software solutions and IT services. Built with React, ShadCN, and TailwindCSS, it features a sleek landing page, service offerings, case studies, and a contact section. This website ensures a user-friendly and responsive experience, making it perfect for showcasing software solutions effectively",
//     }
//     return (
//         <>
...
//                     <img src={project9} className='object-cover relative top-44' alt="" />
//                 </div>
//             </section>
...
export default function Project7() {
    ...
    const handleClick = () => {
        window.open("https://example.com/ai-chat", "_blank");
    };
